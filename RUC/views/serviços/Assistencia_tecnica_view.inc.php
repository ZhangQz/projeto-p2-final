            ...
            <div class="row preto">
                ...
                <div class="col_6 este_servico">
                    <div class="assis_tecn_apresentacao">
                        ...
                        <p class="a_t_a_1">O nosso departamento técnico está disposto ajudar a si com qualquer assistência técnica que precise relacionado com som.</p>
                    ...
                    <form class="assis_tecn_form" id="assis_tecn">
                        ...
                        <input type="text" placeholder="João Santos"><br>
                        <label>Email que devemos contactar:</label><br>
                        <input type="text" placeholder="joao.santos@cenas.pt"><br>
                        <label>Tipo de assistência que precisa:</label><br>
                        <select>
                            <option value="Concertos">Concertos</option>
                            <option value="Captação Exterior">Captação Exterior</option>
                            <option value="Montagem de Sistemas de Som">Montagem de Sistemas de Som</option>
                            <option value="Outros">Outros</option>
                        </select><br>
                        <label>Mensagem que queira deixar para os nossos técnicos:</label><br>
                ...
                <div class="col_2 outros_servicos">
                    ...
                    <div class="outros_prod">
                        <img src="assets/Images/Producao_icon.png" alt="produção icon">
                        <p>Produção</p>
                    </div>
